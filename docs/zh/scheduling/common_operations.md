...
以Atlas A3 训练系列产品为例，回显示例如下；不同设备的回显参数可能不同，以实际为准。关键参数说明请参见[表1](#table189505125431444)。
...
以Atlas A3 训练系列产品为例，回显示例如下；不同设备的回显参数可能不同，以实际为准。关键参数说明请参见[表1](#table25031946405)。
...
以Atlas A3 训练系列产品为例，回显示例如下；不同设备的回显参数可能不同，以实际为准，关键参数说明请参见[表2](#table189505125431456)。
...
以Atlas A3 训练系列产品为例，回显示例如下；不同设备的回显参数可能不同，以实际为准。关键参数说明请参见[表3](#table9246232250)。
