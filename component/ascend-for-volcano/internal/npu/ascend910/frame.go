...
import (
	...
	"volcano.sh/volcano/pkg/scheduler/plugins/ascend-volcano-plugin/internal/npu/ascend910/ascend910b/card910bx2"
	"volcano.sh/volcano/pkg/scheduler/plugins/ascend-volcano-plugin/internal/npu/ascend910/ascend910b/card910bx2infer"
	"volcano.sh/volcano/pkg/scheduler/plugins/ascend-volcano-plugin/internal/npu/ascend910/ascend910b/module910bx16"
	"volcano.sh/volcano/pkg/scheduler/plugins/ascend-volcano-plugin/internal/npu/ascend910/ascend910b/module910bx8"
	"volcano.sh/volcano/pkg/scheduler/plugins/ascend-volcano-plugin/internal/npu/ascend910/asend910old/card910x2"
	"volcano.sh/volcano/pkg/scheduler/plugins/ascend-volcano-plugin/internal/npu/ascend910/asend910old/half910x4"
...
func New(npuName string) plugin.ISchedulerPlugin {
	...
	npuPlugin.Kind[module910a3x16.SchedulerName] = module910a3x16.New(module910a3x16.SchedulerName)
	return npuPlugin
}
...
func (tp *ascend910) PreStartAction(ssn *framework.Session) error {
	...
	if err := tp.handle.PreStartAction(ssn); err != nil {
		return err
	}
	return nil
}
