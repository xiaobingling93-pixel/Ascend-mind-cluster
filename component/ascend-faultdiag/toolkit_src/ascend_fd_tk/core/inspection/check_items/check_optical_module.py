...
from ascend_fd_tk.core.common.diag_enum import Customer, DeviceType
...
from ascend_fd_tk.core.inspection.config.base import OpticalThreshold, FaultDescTemplate
