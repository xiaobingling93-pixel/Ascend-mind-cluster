...
from diag_tool.core.cli_module.base import CliModel, DetailedCliModel, CliCtx
...
from diag_tool.examples.auto_diag.auto_collect import AutoCollect
from diag_tool.examples.auto_diag.auto_diag import AutoDiagCluster
from diag_tool.examples.auto_diag.collect_bmc_log import CollectBmcLog
from diag_tool.examples.inspection.inspection import Inspection
...
class AboutCliModel(CliModel):
    ...
    def run_task(self, *args) -> str:
        return f"""
        MindCluster链路诊断工具版本: {self.diag_ctx.tool_config.version}
        """
