...
type HuaWeiAIChip struct {
	...
	// the hbm info
	HbmInfo *common.HbmAggregateInfo `json:"hbm_info"`
	...
	// SioInfo sio status between dies, only support super pod
	SioInfo *common.SioCrcErrStatisticInfo
	// HccsStatisticInfo gives hccs statistic info, reports error hccs counts
